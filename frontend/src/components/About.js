...
import noteImg from './writingNote.jpg'

function About() {
    return (

        <div className="container">
            <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center" style={{ height: '100vh' }}>
                <div className="col-12 col-lg-6 col-xl-5">
                    <img className="img-fluid rounded" loading="lazy" src={noteImg} alt="About 1" />
                </div>
                <div className="col-12 col-lg-6 col-xl-7">
                    <div className="row justify-content-xl-center">
                        <div className="col-12 col-xl-11">
                            <h2 className="mb-3 fs-4">Who Are We?</h2>
                            <p className="lead fs-5 text-secondary mb-3">We help people to write incredible words and personal information. Our perspective is to furnish outstanding captivating services.</p>
